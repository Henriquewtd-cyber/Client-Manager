...
function getEventsForHour(events: any[], date: any, hour: number) {
    return events.filter((e) => {
        const start = dayjs(e.start);
...
function EventPill({ event, onClick, compact = false }: any) {
    return (
        <div
            ...
            title={`${event.title}${event.nomeCliente ? ` — ${event.nomeCliente}` : ""}`}
...
// ─── Month View ───────────────────────────────────────────────────────────────
export function MonthView({ current, events, onEventClick, onDayClick }: any) {
                    ...
                    return (
                        ...
                        >
                            <div className="flex justify-start mb-1">
                                <div
                                    className={`w-7 h-7 flex items-center justify-center rounded-full text-sm font-semibold ${isToday
...
// ─── Week View ────────────────────────────────────────────────────────────────
export function WeekView({ current, events, onEventClick }: any) {
...
// ─── Day View ─────────────────────────────────────────────────────────────────
export function DayView({ current, events, onEventClick }: any) {
...
// ─── Agenda View ──────────────────────────────────────────────────────────────
export function AgendaView({ current, events, onEventClick }: any) {
